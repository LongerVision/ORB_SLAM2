                                 ...
                                 int nIterations, bool* pbStopFlag, const unsigned long nLoopKF, const bool bRobust)
{
    ...
    // Pei JIA, 2016-10-22. replaced by the following
    if (DENSE)
    {
...
//           new g2o::LinearSolverEigen<g2o::BlockSolver_7_3::PoseMatrixType>();
    g2o::BlockSolver_7_3::LinearSolverType * linearSolver = NULL;

    if (DENSE)
    {
        linearSolver= new g2o::LinearSolverDense<g2o::BlockSolver_7_3::PoseMatrixType>();
        std::cerr << "Using DENSE" << std::endl;
    }
    else
    {
    #ifdef G2O_HAVE_CHOLMOD
        std::cerr << "Using CHOLMOD" << std::endl;
        linearSolver = new g2o::LinearSolverCholmod<g2o::BlockSolver_7_3::PoseMatrixType>();
    #elif defined G2O_HAVE_CSPARSE
...
//    vSim3->_focal_length2[1] = K2.at<float>(1,1);
    g2o::VertexSim3Expmap * vSim3_left = new g2o::VertexSim3Expmap();
    g2o::VertexSim3Expmap * vSim3_right = new g2o::VertexSim3Expmap();
    vSim3_left->_fix_scale=bFixScale;
    vSim3_left->setEstimate(g2oS12);
    vSim3_left->setId(0);
    vSim3_left->setFixed(false);
    vSim3_left->_principle_point[0] = K1.at<float>(0,2);
    vSim3_left->_principle_point[1] = K1.at<float>(1,2);
    vSim3_left->_focal_length[0] = K1.at<float>(0,0);
    vSim3_left->_focal_length[1] = K1.at<float>(1,1);      
    vSim3_right->_fix_scale=bFixScale;
    vSim3_right->setEstimate(g2oS12);
    vSim3_right->setId(0);
    vSim3_right->setFixed(false);
    vSim3_right->_principle_point[0] = K2.at<float>(0,2);
    vSim3_right->_principle_point[1] = K2.at<float>(1,2);
    vSim3_right->_focal_length[0] = K2.at<float>(0,0);
    vSim3_right->_focal_length[1] = K2.at<float>(1,1);
    optimizer.addVertex(vSim3_left);
    optimizer.addVertex(vSim3_right);
    ///////////////////////////////////////////////////////////////////////////////////////////
